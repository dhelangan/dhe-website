...
export default function PortfolioFilters({
  ...
  return (
    <details
      ...
      className="group rounded-3xl border border-black/10 bg-surface shadow-sm dark:border-white/10"
    >
      <summary className="flex cursor-pointer items-center justify-between gap-4 p-4 text-sm font-semibold tracking-tight text-zinc-700 transition-colors hover:bg-black/2 dark:text-zinc-300 dark:hover:bg-white/2">
        <span>Filters</span>
        <span className="inline-flex h-10 items-center justify-center rounded-full border border-black/10 bg-background px-4 text-sm font-semibold transition-colors dark:border-white/10 dark:bg-zinc-950">
          {isOpen ? "Hide filters" : "Show filters"}
        </span>
      </summary>

      <div className="border-t border-black/10 px-6 pb-6 pt-5 dark:border-white/10">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-full border border-black/10 bg-background px-4 text-sm font-semibold transition-colors hover:bg-black/4 dark:border-white/10 dark:bg-zinc-950 dark:hover:bg-white/6"
            >
              Clear
            </button>
            <button
                  ...
                  <button
                    ...
                    className={[
                      ...
                      checked
                        ...
                        : "border-black/10 bg-background hover:bg-black/4 dark:border-white/10 dark:bg-zinc-950 dark:hover:bg-white/6",
                    ].join(" ")}
                  >
