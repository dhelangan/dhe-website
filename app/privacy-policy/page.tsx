        ...
        <div className="grid gap-8">
          ...
          >
            <div className="policy-text">
              ...
              <h2 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Interpretation and Definitions</h2>
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Interpretation</h3>
              <p>The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Definitions</h3>
              ...
              <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Dhelangan Studio.</p>
              </li>
              <li>
              ...
              <li>
              <p><strong>Website</strong> refers to Dhelangan Studio, accessible from <a href="http://dhelangan.com" rel="external nofollow noopener" target="_blank">http://dhelangan.com</a>.</p>
              </li>
              <li>
              <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
              </li>
              </ul>
              <h2 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Collecting and Using Your Personal Data</h2>
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Types of Data Collected</h3>
              <h4 className="text-accent-orange pt-4  my-2 text-lg font-semibold tracking-tight">Personal Data</h4>
              <p>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
              <ul className="my-2 list-disc">
              <li>Email address</li>
              <li>First name and last name</li>
              </ul>
              <h4 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Usage Data</h4>
              ...
              <h4 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Tracking Technologies and Cookies</h4>
              ...
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Use of Your Personal Data</h3>
              ...
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Retention of Your Personal Data</h3>
              ...
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Transfer of Your Personal Data</h3>
              ...
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Delete Your Personal Data</h3>
              ...
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Disclosure of Your Personal Data</h3>
              <h4 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Business Transactions</h4>
              <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
              <h4 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Law enforcement</h4>
              <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
              <h4 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Other legal requirements</h4>
              ...
              <h3 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Security of Your Personal Data</h3>
              ...
              <h2 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Children&apos;s Privacy</h2>
              ...
              <h2 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Links to Other Websites</h2>
              <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&apos;s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
              <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
              <h2 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Changes to this Privacy Policy</h2>
              <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
              <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
              <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
              <h2 className="text-accent-orange pt-4 my-2 text-lg font-semibold tracking-tight">Contact Us</h2>
              <p>If you have any questions about this Privacy Policy, You can contact us:</p>
              <ul className="my-2 list-disc">
              <li>
              <p>By email: dhelangan@gmail.com</p>
              </li>
              <li>
              <p>By visiting this page on our website: <a href="http://dhelangan.com" rel="external nofollow noopener" target="_blank">http://dhelangan.com</a></p>
              </li>
              </ul>
            </div>
          </section>
